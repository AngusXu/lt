      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="37%" align="center" bgcolor="#F3FCFB" class="blue14">Member</td>
            <td width="19%" align="center" bgcolor="#F3FCFB" class="blue14">Integral</td>
            <td width="17%" align="center" bgcolor="#F3FCFB" class="blue14">Grade</td>
            </tr>
		 <?php
$sql="select * from hy where 1=1";	//构造一个查询会员的SQL语句
$sql=$sql." order by jf desc";//继续构造SQL语句
...
?>
          <tr>
            ...
            <td height="28" align="center" class="black"><?=$rs["username"]//显示用户名?></td>
            <td height="28" align="center" class="black"><?=$rs["jf"]?></td>
            <td height="28" align="center" class="black"><?=turndj($rs["username"])?></td>
            </tr>
<?
  }
}
